# main.py
from src.phases.phase1 import run_phase1
from src.phases.phase2 import run_phase2
from src.phases.phase3 import run_phase3
from src.phases.phase4 import run_phase4
